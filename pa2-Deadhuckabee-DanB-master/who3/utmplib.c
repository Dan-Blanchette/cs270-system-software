 ...
 * @version 0.1
 * @date  Started: 10-2-2020
 * 
 * acknowledgements: Hayden Carol for peer review and guidence with a utmpReload() and utmpNext()
 * his help allowed me to understand why I was encountering a seg fault core dump on server tests.
 * 
 */
#include "utmplib.h"
...
struct utmp* utmpNext()
{
    ...
    // nothing left to reload from the utmp file to the buffer
    // return NULL.
    ...
    recp = &utmpbuf[curRec]; // Not sure if this is one of the issues.
...
int utmpReload()
{
    ...
    numRecs = amtRead / sizeof(struct utmp);
